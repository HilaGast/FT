...
figs_folder = r'G:\data\V7\HCP\pca analysis results\Figs\xgboost_results - PCA20'
...
r.to_excel(rf'G:\data\V7\HCP\pca analysis results\Figs\xgboost_results - PCA20\permutation_results_alpha1_test20_N1000_rand.xlsx')
