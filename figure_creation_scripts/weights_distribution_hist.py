...
plt.hist(num,15, color=[0.2, 0.7, 0.6], histtype='step',linewidth=3, range=(0, 100))
plt.hist(add,15, color=[0.2, 0.5, 0.8], histtype='step',linewidth=3, range=(0, 100))
plt.hist(fa,15, color=[0.3, 0.3, 0.5], histtype='step',linewidth=3, range=(0, 100))
plt.hist(dist,15, color=[0.8, 0.5, 0.3], histtype='step',linewidth=3, range=(0, 100))
