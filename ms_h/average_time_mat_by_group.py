...
def average_time_mat(group_subj, group_name, main_fol, mat_type, atlas_type):
    calc_avg_mat(group_subj,mat_type,main_fol, calc_type='mean', atlas_type = atlas_type, adds_for_file_name=group_name)
...
if __name__ == '__main__':
    ...
    a = np.load(rf'F:\Hila\TDI\siemens\mean_{mat_type}_{atlas_type}_{exp}_h.npy')
    b = np.load(rf'F:\Hila\TDI\siemens\mean_{mat_type}_{atlas_type}_{exp}_ms.npy')
