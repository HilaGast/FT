...
class GM_mask:
    ...
    def _load_gm_mask(self, type=None):
        '''
    ...
    def _streamline_name(self):
        import glob
        tract_path = self.folder_name + 'streamlines'
        try:
            streamline_name = glob.glob(tract_path+os.sep+self.tractography_type+'*')[0]
        except IndexError:
