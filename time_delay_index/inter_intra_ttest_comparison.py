...
t, p = ttest(
    mat_intra[~np.isnan(mat_intra)],
    mat_inter[~np.isnan(mat_inter)],
    type="independent",
...
plt.bar(
    [1, 2, 3, 4, 5, 6, 7, 8],
    [
        np.nanmean(vals_intra[0]),
        np.nanmean(vals_inter[0]),
        np.nanmean(vals_intra[1]),
        np.nanmean(vals_inter[1]),
        np.nanmean(vals_intra[2]),
        np.nanmean(vals_inter[2]),
        np.nanmean(vals_intra[3]),
        np.nanmean(vals_inter[3]),
    ],
    yerr=[
        np.nanstd(vals_intra[0]),
        np.nanstd(vals_inter[0]),
        np.nanstd(vals_intra[1]),
        np.nanstd(vals_inter[1]),
        np.nanstd(vals_intra[2]),
        np.nanstd(vals_inter[2]),
        np.nanstd(vals_intra[3]),
        np.nanstd(vals_inter[3]),
    ],
