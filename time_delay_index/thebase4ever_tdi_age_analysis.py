...
#
draw_scatter_fit_weights(ages, tdi, 'Age', 'TDI',(18,80),(10, 150), c=[0.3,0.3,0.5])
draw_scatter_fit_weights(ages, tdi_intra, 'Age', 'TDI \n(inside hemispheres)',(18,80),(10, 150), c=[0.3,0.3,0.5])
draw_scatter_fit_weights(ages, tdi_inter, 'Age', 'TDI \n(between hemispheres)',(18,80),(10, 150), c=[0.3,0.3,0.5])
