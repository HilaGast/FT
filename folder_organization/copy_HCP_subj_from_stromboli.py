...
stromboli_folders = glob.glob(f'Y:\qnap_hcp\*{os.sep}')
move_to_folder = r'G:\data\V7\HCP'
source_files = [r'AxCaliber\ADD.nii.gz',r'AxCaliber\FA.nii.gz',r'AxCaliber\MD.nii.gz',r'tracts\HCP.tck',r'raw_data\mprage.nii.gz',r'raw_data\data.nii.gz',r'nodif\HCP.nii.gz',r'raw_data\brain_mask.nii.gz',r'raw_data\bvals',r'raw_data\bvecs']
